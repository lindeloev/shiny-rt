...
<!--
TO DO NOW:
 * Add cheat sheet to "evaluation" section.
 * Update on shiny server
...
All too often, researchers use the normal distribution to model reaction times. I can understand this. Changing carries with it the cognitive burden of having to learn something new, and statistics is hard. I made this document to lower this burden by helping intuition along and providing copy-and-paste ready code examples.
...
Because $\mu$ and $\sigma$ define the *log*-normal, they are on a log scale. This means that we expect a median RT of `exp(-0.69) = 0.50` seconds for condition "accuracy" (the intercept), and a median RT of `exp(-0.69 -0.40) = 0.34` seconds for condition "speed". If you get confused about these transformations, worry not. `brms` has you covered, no matter the distribution:
